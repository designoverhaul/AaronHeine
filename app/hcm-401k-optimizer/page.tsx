  ...
  return (
    <Layout>
      ...
      <div className="featured-image">
        <Image
          src="https://wp.wp.aaronheine.com/wp-content/uploads/2023/11/UI-UX.jpg"
      ...
      <div className="entry-content">
        ...
        <Image
          src="https://wp.wp.aaronheine.com/wp-content/uploads/2021/04/Journey-map-scaled.jpg"
          alt="Journey map"
          width={2560}
          height={1411}
        ...
        <Image
          src="https://wp.wp.aaronheine.com/wp-content/uploads/2021/04/login-1.jpeg"
          alt="Login screen"
          width={920}
          height={430}
        ...
        <Image
          src="https://wp.wp.aaronheine.com/wp-content/uploads/2021/04/Screen-One.jpeg"
          alt="Screen one"
          width={1161}
          height={1621}
          className="aligncenter size-full"
        ...
        <Image
          src="https://wp.wp.aaronheine.com/wp-content/uploads/2021/05/Recomendations.jpeg"
          alt="Recommendations"
          width={2236}
          height={1615}
          className="aligncenter size-full"
        ...
        <Image
          src="https://wp.wp.aaronheine.com/wp-content/uploads/2021/04/SDBA.jpeg"
          alt="SDBA banner"
          width={527}
          height={351}
          className="size-full"
        ...
        <Image
          src="https://wp.wp.aaronheine.com/wp-content/uploads/2021/04/Dashboard2.jpeg"
        ...
        <Image
          src="https://wp.wp.aaronheine.com/wp-content/uploads/2021/04/iFrame.jpeg"
          alt="iFrame"
          width={1134}
          height={824}
        ...
        <Image
          src="https://wp.wp.aaronheine.com/wp-content/uploads/2021/05/Participants-1024x498.jpg"
          alt="Participants"
          width={1378}
          height={670}
          className="alignnone size-full"
        ...
        <Image
          src="https://wp.wp.aaronheine.com/wp-content/uploads/2021/05/Record-Keepers-1024x498.jpg"
          alt="Record Keepers"
          width={1378}
          height={670}
          className="alignnone size-full"
        ...
        <Image
          src="https://wp.wp.aaronheine.com/wp-content/uploads/2021/05/Single-Participant.jpg"
