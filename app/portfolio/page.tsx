  ...
  return (
    <Layout>
      ...
      <div className="caseStudies">
        ...
        <Link href="/harmonia">
          <Image
            src="https://wp.wp.aaronheine.com/wp-content/uploads/2024/01/violin.png"
      ...
      <div style={{ width: '100vw', position: 'relative', left: '50%', right: '50%', marginLeft: '-50vw', marginRight: '-50vw' }}>
        <ImageGallery>
          ...
          <div className="wide">
            <img
              src="https://wp.wp.aaronheine.com/wp-content/uploads/2024/08/stan2.jpg"
              className="image"
              alt="Portfolio work"
            />
          </div>
          <div className="wide">
            <img
              src="https://wp.wp.aaronheine.com/wp-content/uploads/2024/01/Twist-Locs-Coils.jpg"
              className="image"
              alt="Portfolio work"
            />
          </div>
          <div className="tall">
            <img
              src="https://wp.wp.aaronheine.com/wp-content/uploads/2023/11/Supershot-e1701442706221.jpg"
              className="image"
              alt="Portfolio work"
            />
          </div>
          <div className="wide">
            <img
              src="https://wp.wp.aaronheine.com/wp-content/uploads/2024/01/HoganTaylor-UI-1280x960-1.jpg"
              className="image"
              alt="Portfolio work"
            />
          </div>
          <div className="big">
            <img
              src="https://wp.wp.aaronheine.com/wp-content/uploads/2023/11/walden-scaled-e1701442551670.jpg"
              className="image"
              alt="Portfolio work"
            />
          </div>
          <div className="wide">
            <img
              src="https://wp.wp.aaronheine.com/wp-content/uploads/2024/08/Emory-e1701442914953.jpg"
              className="image"
              alt="Portfolio work"
            />
          </div>
          <div className="wide">
            <img
              src="https://wp.wp.aaronheine.com/wp-content/uploads/2023/11/ActionMoves-e1701442942712.jpg"
              className="image"
              alt="Portfolio work"
            />
          </div>
